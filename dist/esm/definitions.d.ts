import type { CapabilityOption, PlayStoreOptions, WatchConnectedOptions, WatchSendOptions } from './options';
...
export interface WatchLinkPlugin {
     ...
     */
    listen(callback: (result: {
        [key: string]: string;
    }) => any): Promise<WatchLinkResult>;
    /**
     ...
     */
    hasCompanionAppInstalled(options: CapabilityOption): Promise<{
        result: boolean;
    }>;
}
