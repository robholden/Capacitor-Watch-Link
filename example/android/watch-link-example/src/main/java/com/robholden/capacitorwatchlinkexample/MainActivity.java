...
import com.capacitorplugin.watchlinkexample.databinding.ActivityMainBinding;
        ...
        public void onReceive(Context context, Intent intent) {
            switch (intent.getAction()) {
                case WatchWearableListenerService.TEST_ACTION:
                    ...
                    new SendMessage(
                        "/test-device-path",
                        "{\"answer\": \"" + deviceMessage + "\", \"happy\": " + (happy ? "true" : "false") + "}"
                    )
                        .start();
                    break;
            }
            ...
            try {
                ...
                for (Node node : nodes) {
                    Task<Integer> sendMessageTask = Wearable
                        .getMessageClient(MainActivity.this)
